...
const USPS = [
  { icon: "Zap", title: "Срок от 1 дня", desc: "Собственный склад материалов. Пока другие ждут поставок, мы запускаем в работу." },
  { icon: "Layers", title: "Полный цикл", desc: "От наклейки до кинодекорации" },
