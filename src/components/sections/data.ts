...
export const REVIEWS = [
  ...
  },
  {
    ...
    role: "Ивент-менеджер",
    text: "Оформили всё для нашей выставки в рекордные сроки. Качество печати просто великолепное — клиенты были в восторге. Отдельное спасибо за помощь с макетами и оперативную обратную связь.",
    stars: 5,
  },
  {
    name: "Дмитрий Орлов",
    role: "Владелец кафе",
    text: "Заказывал интерьерное оформление. Посоветовали лучший материал для кухни, помогли с макетом. Результат превзошёл ожидания — гости постоянно спрашивают, где мы делали.",
    stars: 5,
  },
  {
    name: "Ирина Васильева",
    role: "Продюсер",
    text: "Работаем с ФильмПринт уже третий год. Ни разу не подвели по срокам, даже когда мы сами затягивали с макетами. Профессионалы своего дела.",
    stars: 5,
  },
  {
    name: "Сергей Лебедев",
    role: "Руководитель отдела маркетинга",
    text: "Заказывали брендирование офиса под ключ. Всё сделали быстро, чисто и аккуратно. Цена оказалась ниже, чем у конкурентов, а качество — выше.",
    stars: 5,
  },
];
