...
import { SERVICES, PRICING, PORTFOLIO_ITEMS } from "./constants";
...
export default function ServicesSection({ scrollTo }: ServicesSectionProps) {
  ...
  return (
    <>
      ...
      <section id="services" className="py-24 bg-white relative overflow-hidden">
        <div className="absolute left-0 top-1/4 w-[400px] h-[400px] rounded-full opacity-5"
